...
>   `noop/20260616-omniwm-235-window-bleed-different-workspace.md`. Floating windows
...
upstream-symptom record `noop/20260616-omniwm-235-window-bleed-different-workspace.md`.
...
of the test `noop/20260616-omniwm-235-window-bleed-different-workspace.md` recommends.
