# Hiro issue #240 — "Focus previous window command doesn't work across workspaces" — Discovery

Source issue: https://github.com/BarutSRB/Hiro/issues/240
Filed against: `BarutSRB/Hiro` (upstream of nehir — `NOTICE.md` states nehir is a
fork of `BarutSRB/OmniWM`, renamed to Hiro).
...
like upstream Hiro — silently falls back to a window in the current workspace.
...
This is **not** owned by the sibling discovery `20260616-hiro-317-…`. That doc
