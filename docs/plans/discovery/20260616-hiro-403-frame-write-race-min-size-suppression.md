# Hiro PR #403 — "Break AX frame-write race loop for min-size apps" — Discovery

Source PR: https://github.com/BarutSRB/Hiro/pull/403
Filed against: `BarutSRB/Hiro` (upstream of nehir — see `NOTICE.md`; nehir is a
fork of `BarutSRB/OmniWM`, which was renamed to Hiro).
