...
(`docs/plans/20260614-narrow-wmcontroller-public-surface.md`).
...
Finding #7 / `docs/plans/20260614-narrow-wmcontroller-public-surface.md`. Do this
...
- `docs/plans/20260614-narrow-wmcontroller-public-surface.md` — the related
  finding #7 plan; do this before adding layout paradigms/interactive modes.

## References

- `docs/plans/discovery/20260613-codebase-review-findings.md` — findings #5, #6,
