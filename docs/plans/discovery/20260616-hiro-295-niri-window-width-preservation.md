# Hiro issue #295 — "[Niri] Windows do not keep their current width when moved to another workspace on another screen" — Discovery

Source issue: <https://github.com/BarutSRB/Hiro/issues/295>
