# Hiro PR #323 — "Restore floating panel classification + bar filter" — Discovery

Source PR: https://github.com/BarutSRB/Hiro/pull/323
...
Yes. `NOTICE.md:3`-`NOTICE.md:7` says nehir forks `BarutSRB/OmniWM`, and that upstream was renamed to Hiro. The relevant renamed paths exist in nehir:
