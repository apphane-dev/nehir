# Hiro issue #226 — "Hotkeys overridden by Chrome extension shortcuts" — Discovery

Source issue: <https://github.com/BarutSRB/Hiro/issues/226>
...
Yes. `NOTICE.md` says nehir forks `BarutSRB/OmniWM`, renamed upstream to Hiro.
The cited Carbon hotkey implementation exists in nehir as
