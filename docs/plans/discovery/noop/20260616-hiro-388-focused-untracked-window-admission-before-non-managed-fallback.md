# Hiro PR #388 — "Admit focused untracked standard windows before non-managed fallback (activation race)" — Discovery

Source PR: <https://github.com/BarutSRB/Hiro/pull/388> (fixes Hiro issue #387)
...
> (`20260616-hiro-379-focus-revert-grace-period.md`,
> `20260616-hiro-317-rapid-focus-revert-race.md`). Applying the PR's diff would
...
- **Symptom (from PR body / fixes #387):** when OmniWM/Hiro receives an app
...
3. **Lineage is independent, not a cherry-pick.** The PR was closed without
   ...
   (`20260616-hiro-379-focus-revert-grace-period.md`,
   `20260616-hiro-317-rapid-focus-revert-race.md`), which extend this same
...
- Sibling discoveries that build on this same admission path:
  - `docs/plans/discovery/20260616-hiro-379-focus-revert-grace-period.md`
  - `docs/plans/discovery/20260616-hiro-317-rapid-focus-revert-race.md`
