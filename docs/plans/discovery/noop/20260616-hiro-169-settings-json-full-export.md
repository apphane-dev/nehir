# Hiro PR #169 — "settings.json full canonical export" — Discovery

Source PR: https://github.com/BarutSRB/Hiro/pull/169
...
> `docs/plans/discovery/20260616-hiro-410-settings-toml-unknown-keys-roundtrip-loss.md`.
...
- **Verdict:** ⚪ **Won't port / Not applicable.** The only overlapping bug class
  ...
  (`docs/plans/discovery/20260616-hiro-410-settings-toml-unknown-keys-roundtrip-loss.md:9-11`).
...
Partially in lineage, but not in API shape. `NOTICE.md` confirms nehir forks
`BarutSRB/OmniWM`, renamed upstream to Hiro. The current nehir config model is
