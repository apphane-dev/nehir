# Hiro issue #235 — "Window bleeds into different workspace" — Discovery

Source issue: <https://github.com/BarutSRB/Hiro/issues/235>
...
#349 (`noop/20260616-hiro-349-hidden-window-bleeds-multi-monitor.md`).
...
> `…-hiro-235-window-bleeds-into-workspace.md` was removed).
...
Yes. nehir forks OmniWM (renamed Hiro); see `NOTICE.md`. Every symbol #235's symptom
...
Filed 2026-04-13 on OmniWM/Hiro **0.4.7.4** by `flschulz` (ultrawide monitor):
