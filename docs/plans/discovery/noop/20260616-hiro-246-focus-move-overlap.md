# Hiro issue #246 — "Windows overlapping after focus move" — Discovery

Source issue: <https://github.com/BarutSRB/Hiro/issues/246>
...
> `docs/plans/discovery/20260616-stale-live-frame-on-stably-hidden-column.md`,
> with cross-workspace overlap already catalogued in
> `docs/plans/discovery/noop/20260616-hiro-235-window-bleed-different-workspace.md`.
...
Yes. The issue was filed against Hiro/OmniWM, and `NOTICE.md` says nehir forks
`BarutSRB/OmniWM`, later renamed Hiro. The symbols named by the upstream fix and
reproduction exist in nehir:
