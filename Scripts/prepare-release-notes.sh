...
if [ "$#" -ne 1 ]; then
  ...
  echo "Example: Scripts/prepare-release-notes.sh 0.2.2" >&2
  exit 1
fi
...
# Official Changesets frontmatter shape:
# ---
# "package-name": patch|minor|major|none
# ---
# Summary.
